...
public class CH2_Notes_3
{
    public static void stringExamples() {
        ...
        System.out.println("The character \"I\" occurs at index 0 :" + title2.charAt(0));
        
        //The length of a string:
        System.out.println("The length of the string is :" + title2.length());
        ...
        System.out.println(title2.replace("a", "@"));
